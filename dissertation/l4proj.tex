...
%
\usepackage{pdfpages, subfiles} % if you want to include a PDF for an ethics checklist, for example
%
%
...
%==============================================================================
%% METADATA
\title{Full Abstraction for the encoding of Session Types in $\pi$-Calculus} % change this to your title
\author{Iain W. McLean}
\date{April 9, 2021}
...
%% ABSTRACT
\begin{abstract}
    The previous work in the paper "Session Types Revisited" presented a variation of the $\pi$-calculus extended with session types. This paper extends this calculus with a notion of behavioural equivalences as to demonstrate that the encoding presented is fully abstract w.r.t fair testing. 
...
I would like to thank my supervisor Dr. Ornela Dardha for her continued guidance throughout the project, and having a laugh along the way. I would also like to thank my family for their continued support, and my friends that have made completing my last year during lockdown possible.

Finally I would like to thank Romain Demangeon for his work in this area and leave my condolences with Kohei Honda and his family.
...
% Why should the reader care about what are you doing and what arxe you actually doing?
% \section{Overview}
\subfile{sections/introduction}

% Session typed $\pi$-calculus provides a framework to accurately model computations between multiple nodes, being able to write them as well typed processes similar to other CCS based process calculi. This paper is to tackle one of the most difficult problems surrounding process calculi, proving full abstraction. Full Abstraction is the notion that two terms are only equivalent if and only if their encodings are equivalent. As discussed in previous papers, to tackle this problem on concurrent process calculi its more appropriate to observe process behaviour rather than define equalities based on denotational semantics. This paper will follow this same process, define behavioural equivalences between the calculi defined in the paper Session Types Revisited and finally derive the full abstraction theorem.
